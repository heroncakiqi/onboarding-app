...
const OnboardingScreenThree = props => {
  return (
    <Container>
      <LinearGradient style={styles.background} colors={['#7bdda9', '#41b8b1']}>
        <Content contentContainerStyle={styles.content}>
          <H1 style={styles.text}>Light and Dark theme</H1>
          <View style={styles.imageContainer}>
            <Image
              style={styles.mockup}
              source={require('../../assets/onboarding-three/white-phone.png')}
            />
            <Image
              style={styles.mockup}
              source={require('../../assets/onboarding-three/black-phone.png')}
            />
          </View>
          ...
          <View style={styles.buttonContainer}>
            ...
            <NiceButton style={styles.button} onPress={() => props.goNext()}>
              Sign up
            </NiceButton>
          </View>
        </Content>
