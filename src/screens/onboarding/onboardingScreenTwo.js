...
const OnboardingScreenTwo = props => {
  return (
    <Container>
      <LinearGradient colors={['#fa9f87', '#f27d8e']} style={styles.background}>
        <Content contentContainerStyle={styles.content}>
          <View style={styles.textContainer}>
            <H1 style={{...styles.text, ...styles.title}}>
          ...
          <Image
            style={styles.mockup}
            source={require('../../assets/onboarding-two/mockup.png')}
          />
          ...
          <Image
            style={styles.fade}
            source={require('../../assets/onboarding-two/gradient.png')}
          />
        </Content>
      </LinearGradient>
    </Container>
